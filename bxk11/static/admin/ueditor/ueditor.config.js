...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,maxImageSideLength:800                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        /*,savePath: [ '../../../../uploads/upload1' ]*/    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        , toolbars:[
                    ['source', '|', 'undo', 'redo', '|',
                        'bold', 'italic', 'underline', 'subscript', 'removeformat', '|', 'forecolor', 'backcolor', '|',
