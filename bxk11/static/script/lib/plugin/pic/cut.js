define('/static/script/lib/plugin/pic/cut', [
  '/static/script/lib/event/mousedown'
  ...
  var click=require('/static/script/lib/event/click');  
    ...
    { 
      ...
      var coverWidth=Math.floor(width*0.5);
      var coverHeight=Math.floor(width*0.5);
        ...
        { 
          ...
          function fnMove(ev)
          {
            ...
            { 
              ...
              if(_downX<=downWidth+oParent.offsetTop-height-top)_downX=downWidth+oParent.offsetTop-height-top;
              ...
              oParent.style.height=_width+'px';
            ...
            { 
              ...
              if(x>=height-(oParent.offsetTop-top))x=height-(oParent.offsetTop-top);

              oParent.style.width=x+'px';
              oParent.style.height=x+'px';
            }
            ...
            if(obj.className.indexOf('t')!=-1)
            {
              ...
              if(_downY<=oParent.offsetLeft+downHeight-left-width){_downY=oParent.offsetLeft+downHeight-left-width};
              ...
              oParent.style.width=_height+'px';
            ...
            { 
              ...
              if(y>=width-(oParent.offsetLeft-left))y=width-(oParent.offsetLeft-left);

              oParent.style.height=y+'px';
              oParent.style.width=y+'px';
            }
