	...
	<div id="manage_content">
		...
		<div id="add_form">
			<form action="<?php echo site_url('admin/ad/pagesave?id='.$id);?>"
				...
				<textarea rows="5" cols="300" name="page_intro"><?php echo $res->apm_desc;?></textarea>
