					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/product/dopackEdit');?>" enctype="multipart/form-data" method="POST" 	onsubmit='return jsv.checkbrands_series_add();'>
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'><input id='series_name' type='text' class="m-wrap medium" name='pack_name' value="<?php echo $re->pack_name;?>" /></td>
										...
										<tr>
											...
											<td colspan='4'>
												...
												?>
												<option value="<?php echo $val['service_id'];?>" <?php if($re->goods_id && $re->goods_id == $val['service_id'])echo "selected";?>><?php echo $val['service_name'];?></option>
												<?php }}?>
												</select>
											</td>
										...
										<tr>
											<input name='pack_id' value="<?php echo $re->pack_id;?>" type='hidden'>
