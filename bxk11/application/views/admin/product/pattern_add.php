					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/product/dopattern_add');?>" enctype="multipart/form-data" method="POST" 	onsubmit='return jsv.checkpattern_add();'>
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											<td colspan='4' style='text-align:right;' width='20%'><span>产品二类:</span></td>
											<td colspan='4'>
												<select class="header-option m-wrap small" name='s_c_tag_id' id="s_c_tag_id">
										...
										<tr>
											...
											<td colspan='4'><input id='pattern_type' type='text' class="m-wrap medium" name='pattern_type'  /></td>
										...
										<tr>
											...
											<td colspan='4'><input type="text"  name="pattern_sort" class="m-wrap medium" /></td>
											
										</tr>
										<tr>

											<td colspan='4' style='text-align:right;'><span>款式描述:</span></td>
											<td colspan='4'><input type='text'  class="m-wrap medium" name='pattern_seodesc' /></td>
