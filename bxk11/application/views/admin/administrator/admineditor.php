          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                <form action="<?php echo site_url('/admin/administrator/doadmineditor');?>" method="post">
					<table class="table table-hover">

						<thead>
							<tr>
								<th colspan='8'>编辑管理员</th>
							</tr>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan='4'><input type="text" name='admin_nikename' value="<?php echo $reg->admin_nikename?>"></td>
								
							</tr>						
						
							<tr>
								<td colspan='4' style='text-align:right;'  width='20%'><span>管理员账户:</span></td>
								<td colspan='4'><input type="text" name='admin_name' value="<?php echo $reg->admin_name?>"></td>
							...
							<tr>
								...
								<td colspan='4'><select name='admin_status'><option value='2'>普通管理员</option><option value='0'>停用</option>
								<?php if($reg->admin_status==1){
									echo "<option value='1' selected='true'>超级管理员</option>";
								}?>
								</select></td>					
							</tr>

							<tr>
								<input type="hidden" name='admin_id' value="<?php echo $reg->admin_id?>">
