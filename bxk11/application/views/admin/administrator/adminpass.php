          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                <form action="<?php echo site_url('/admin/administrator/doadminpass');?>" method="post">
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								<td colspan='4' style='text-align:right;'><span>新密码:</span></td>
								<td colspan='4'>
							...
							<tr>
								<input type="hidden" name='admin_id' value="<?php echo $reg?>">
