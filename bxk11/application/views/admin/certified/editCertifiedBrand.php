				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							认证品牌&amp; 认证品牌编辑  <small>产品认证品牌&amp; 产品管理</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/certified/doEditSysBrand');?>" enctype="multipart/form-data" method="POST" >
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'><input type="text"  name="c_brand_name" class="m-wrap medium" id="c_brand_name" value="<?php echo $re->c_brand_name?>"/></td>
											
										</tr>
										
										<tr>
											<td colspan='4' style='text-align:right;'><span> 品牌英文名称:</span></td>
											<td colspan='4'><input type="text"  name="c_brand_ename" class="m-wrap medium" id='c_brand_ename' value="<?php echo $re->c_brand_ename?>"/></td>
										...
										<tr >
											...
											<td colspan='4'>
												...
												<input type='hidden' value="<?php echo $re->c_brand_logo?>" name='brand_img'>
										...
										<tr>
											...
											<td colspan='4'><input type="text"  name="c_brand_website" class="m-wrap medium" id="c_brand_website" value="<?php echo $re->c_brand_website?>"/></td>
											
										</tr>
										
										<tr>
											<td colspan='4' style='text-align:right;'><span> 品牌描述:</span></td>
											<td colspan='4'><input type="text"  name="c_brand_desc" class="m-wrap medium" id="c_brand_desc" value="<?php echo $re->c_brand_desc?>"/></td>
											
										</tr>
										
										<tr>
											<td colspan='4' style='text-align:right;'><span> 关键词:</span></td>
											<td colspan='4'><input type="text"  name="c_brand_keywords" class="m-wrap medium" id='c_brand_keywords' value="<?php echo $re->c_brand_keywords?>"/>(多个以逗号隔开)</td>
											
										</tr>

										<tr>
											<input name='c_brand_id' type="hidden" value="<?php echo $re->c_brand_id;?>">
