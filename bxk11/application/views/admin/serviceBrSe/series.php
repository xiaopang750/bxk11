						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="row-fluid search-forms search-default">
									<form class="form-search" action="<?php echo site_url('admin/serviceBrSe/series')?>" method='get'>
										<div class="chat-form">
										系列状态 :
										<select class="header-option m-wrap small" name='series_status'>
											<option value="" <?php if($series_status == '') echo "selected";?>>请选择</option>
										...
										<input type="hidden" name="brand_id" value="<?php echo $brand_id;?>">
										 	名 称:
										<input  type="text"  class="m-wrap span8" name ='key_word' placeholder=" 系列名称或者经销商登录名或者申请品牌中文名..." value="<?php echo $key_word?>">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<button id="sample_editable_1_new" class="btn green" onclick="javascript:window.location.href='<?php echo site_url('admin/serviceBrSe/serviceBrSeadd')."?service_id=".$service_id."&brand_id=".$brand_id;?>'">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr id="t_ser<?php echo $val->series_id;?>">
											...
											<td><?php if(isset($val->service_id) && $val->service_id) echo get_tag_name('t_service_info_model',$val->service_id,'service_name');?></td>
											...
											<td><a class="edit" href="javascript:jsv.go('<?php echo site_url('admin/product/series_edit').'?series_id='.$val->series_id."&service_id=".$val->service_id;?>');">Edit</a>|<a class="delete" href="javascript:jsv.del_series(<?php echo $val->series_id;?>);">Delete</a></td>
