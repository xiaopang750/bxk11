						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="row-fluid search-forms search-default">
									<form class="form-search" action="<?php echo site_url('admin/member/join')?>" method='get'>
										<div class="chat-form">
											选择地区   :
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr id="t_s<?php echo $val->join_id;?>">
											...
											<td><?php echo $val->join_number;?></td>
											...
											<td>
												<?php if($val->join_status == 1){
														...
														echo "<a href='".site_url('admin/member/add')."?join_id=".$val->join_id."'>添加用户商</a>";
													  }elseif($val->join_status == 3){
														echo "审核失败";
													  }elseif($val->join_status == 4){
													  	echo "<a href='".site_url('admin/member/doAuditing')."?service_id=".$val->service_id."'>继续审核</a>";
													  }elseif($val->join_status == 5){
														echo "审核成功";
													  }elseif($val->join_status == 81){
														echo "屏蔽";
													  }else{
														echo "删除";
													 }?>
											...
											<ul class="nav">
												<li class="dropdown user">
													...
													<ul class="dropdown-menu">
														...
														<?php if($val->join_status != 1){?>
														<li><a href="#" onclick="jsv.status('1',<?php echo $val->join_id; ?>,'join');"><span class="label label-success">审核中</span></a></li>
														<?php }?>

														<?php if($val->join_status != 2 && $val->join_status != 4 && $val->join_status != 5){?>
														<li><a href="#" onclick="jsv.status('2',<?php echo $val->join_id;?>,'join');"><span class="label label-danger">审核成功</span></a></li>
														<?php }?>

														<?php if($val->join_status != 3){?>
														<li><a href="#" onclick="jsv.status('3',<?php echo $val->join_id;?>,'join');"><span class="label label-info">审核失败</span></a></li>
														<?php }?>

														<?php if($val->join_status != 81){?>
														<li><a href="#" onclick="jsv.status('81',<?php echo $val->join_id;?>,'join');"><span class="label-warning">屏蔽</span></a></li>
														<?php }?>
														
														<?php if($val->join_status != 99){?>
														<li><a href="#" onclick="jsv.status('99',<?php echo $val->join_id;?>,'join');"><span class="label-warning">删除</span></a></li>
														<?php }?>
													</ul>
