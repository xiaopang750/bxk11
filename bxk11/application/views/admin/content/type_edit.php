								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'><input id='s_class_name_one' type='text' class="m-wrap medium" name='s_class_name'  value="<?php echo $re->s_class_name;?>"/></td>
										...
										<tr>
											...
											<td colspan='4'>
												<select class="header-option m-wrap small" name='s_class_type'>
													...
													<option value="12" <?php if($re->s_class_type == 12) echo "selected";?>>产品</option>
													<option value="13" <?php if($re->s_class_type == 13) echo "selected";?>>方案案例 </option>
										...
										<tr>
											...
											<td colspan='4'><input type='text'  class="m-wrap medium" name='s_class_seodesc' value="<?php echo $re->s_class_seodesc;?>"/></td>
										...
										<tr>
											...
											<td colspan='4'>
												<?php if($re->s_class_img){?><img src="<?php echo base_url('uploads/theme/source').'/'.$re->s_class_img;?>" width='60' height='60'/><br/><?php }?>
										...
										<tr>
											...
											<td colspan='4'><input type="text"  name="s_class_sort" class="m-wrap medium" value="<?php echo $re->s_class_sort;?>"/></td>
										...
										<tr>
											...
											<td colspan='4'><input type='text'  class="m-wrap medium" name='s_class_regex' value="<?php echo $re->s_class_regex;?>"/></td>
										</tr>
										<tr>
