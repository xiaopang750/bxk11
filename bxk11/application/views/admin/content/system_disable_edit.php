					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/system_disable/doedit');?>" enctype="multipart/form-data" method="POST" 	onsubmit='return jsv.disbale_add();'>
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'>
												<select id='sdisable_type' class="header-option m-wrap small" name='sdisable_type'>
													...
													?>						
													<option value="<?php echo $value['type'];?>" <?php if($value['type'] == $re->sdisable_type) echo "selected";?>><?php echo $value['type_content'];?></option>
													<?php }}?>
										...
										<tr>
											...
											<input id='sdisable_value' class="m-wrap medium" type='text' name='sdisable_value' value=<?php echo $re->sdisable_value;?>>
										...
										<tr>
											<input  class="m-wrap medium"  type="hidden" name='sdisable_id' value=<?php echo $re->sdisable_id;?>>
