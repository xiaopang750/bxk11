					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/tag/doimport');?>" enctype="multipart/form-data" method="POST" onsubmit='return jsv.check();'>
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											<td colspan='4' style='text-align:right;' width='20%'><span>标签图片:</span></td>
