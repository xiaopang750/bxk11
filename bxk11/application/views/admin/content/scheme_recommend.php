					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/scheme_recommend/doscheme_recommend');?>" enctype="multipart/form-data" method="POST" onsubmit="return jsv.scheme_recommend();">
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>案例频道首页轮播-1:</span></td>
										...
										<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>案例频道首页轮播-2:</span></td>
										...
										<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>案例频道首页轮播-3:</span></td>
											<td colspan='4'><input type='text' class="m-wrap medium" tar_key='check' name='scheme_recommend-3' id='scheme_recommend-3' value='<?php if(isset($scheme_recommend['2'])) echo $scheme_recommend['2'];?>'/></td>
																			...
																			<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>案例频道首页轮播-4:</span></td>
										...
										<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>案例频道首页轮播-5:</span></td>
