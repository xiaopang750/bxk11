								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'>
											<input name='house_opendate' class="m-wrap m-ctrl-medium date-picker" type="text" value="<?php if(false){echo $a_end;}else{echo date('Y-m-d',time());}?>" size="16" onfocus="this.className='text2';rcalendar(this,'full');" onblur="this.className='text'">
											</td>
										</tr>
										<tr>
											<td colspan='4' style='text-align:right;'><span>入住日期:</span></td>
											<td colspan='4'>
											<input name='house_checkdate' class="m-wrap m-ctrl-medium date-picker" type="text" value="<?php if(false){echo $house_checkdate;}else{echo date('Y-m-d',time());}?>" size="16" onfocus="this.className='text2';rcalendar(this,'full');" onblur="this.className='text'">
											</td>
										</tr>
