					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<form action="<?php echo site_url('admin/service/domodule_add');?>" enctype="multipart/form-data" method="POST" onsubmit='return jsv.modules();'>
								<table class="table table-hover">

									<thead>

										<tr>
											<th colspan='8'>模块添加</th>
										</tr>
									...
									<tbody>
										...
										<tr>
											...
											<td colspan='4'><input type='text' class="m-wrap medium" name='module_name' id='module_name'/></td>
										...
										<tr>
											...
											<td colspan='4'><input type='text' class="m-wrap medium" name='module_key' id='module_key'/></td>
										</tr>
										...
										<tr >
											...
											<td colspan='4'>
												...
												<input type='hidden' value='' name='module_img_bak'>
											</td>
										</tr>
										
										<tr>
											<td colspan='4' style='text-align:right;'  width='20%'><span>模块排序:</span></td>
											<td colspan='4'><input type='text' class="m-wrap medium" name='module_sort' id='module_sort'/></td>
