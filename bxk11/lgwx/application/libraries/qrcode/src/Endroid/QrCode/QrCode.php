...
include __DIR__."/./Exceptions/DataDoesntExistsException.php";
include __DIR__."/./Exceptions/VersionTooLargeException.php";
include __DIR__."/./Exceptions/ImageSizeTooLargeException.php";
include __DIR__."/./Exceptions/ImageFunctionUnknownException.php";
