            ...
            foreach ($menuR as $key => $value) {
                ...
                if($menuChiledR){
                    ...
                    if($value->smd_type){
                        ...
                        if($value->smd_type == 1){
                            $smd_nameSA[$key]['smd_content'] = $value->smd_content;
                            $smd_nameSA[$key]['smd_ptype'] = $value->smd_type;
                            ...
                            if($value->smd_content){
                                ...
                                foreach ($inId as $ke =>$va) {
                                    ...
                                    if($infoOneR){
                                        $smd_nameSA[$key]['smd_content'][$ke]['si_url'] = $infoOneR->si_pic;
                                        $smd_nameSA[$key]['smd_content'][$ke]['si_title'] = $infoOneR->si_title;
                                        $smd_nameSA[$key]['smd_content'][$ke]['si_pic'] = $infoOneR->si_pic;
                                        $smd_nameSA[$key]['smd_content'][$ke]['si_addtime'] = $infoOneR->si_addtime; 
                                    } 
                                }
                                 if(!isset($smd_nameSA[$key]['smd_content'])){
                                        $smd_nameSA[$key]['smd_content'] = '';
                                 }
                            }else{
                               $smd_nameSA[$key]['smd_content'] = ''; 
                            ...
                            /*if($value->smd_content){
                                ...
                                $smd_nameSA[$key]['smd_content'] = $this->getMenuConfig($cId);
                            }else{
                                $smd_nameSA[$key]['smd_content'] = $this->getMenuConfig();
                            }*/
                            $smd_nameSA[$key]['smd_content'] = $value->smd_content;
                        }else{
                            $smd_nameSA[$key]['smd_ptype'] = '';
    ...
    public function editMenuList(){
        ...
        if($parentA){
            ...
            foreach ($parentA as $key => $value) {
                $parentA[$key]['smd_son_list'] = $this->sonStringToArray($value['smd_pid']);
            }

            $list['menu_list'] = $parentA;
            return $list;
        }else{
                    ...
                    if($value->smd_content){
                        ...
                        foreach ($inId as $ke =>$va) {
                            ...
                            if($infoOneR){
                                ...
                                $list[$key]['smd_content'][$ke]['si_addtime'] = $infoOneR->si_addtime; 
                            }else{
