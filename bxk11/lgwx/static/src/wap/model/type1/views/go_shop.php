...
<link rel="stylesheet" href="<?php echo APP_LINK; ?>model/type1/css/go_shop.css">
...
<section class="go_shop">
	<div class="inner" sc="go_shop">
...
<script>
	seajs.use('model/type1/js/main/go_shop.js');
</script>
</body>
</html>