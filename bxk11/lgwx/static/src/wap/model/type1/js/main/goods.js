define(function(require, exports, module){
	...
	function GoodsSelect() {
		...
		this.initParam = {brand_id: '',class_id: '', series_id: '', num: 10, p: 1, service_id: gparam.service_id, openid:gparam.openid,shop_id:gparam.shop_id};
	...
	GoodsSelect.prototype = {
		...
		selectShow: function() {
			...
			oTplSelect = require('../../tpl/build/goods/search_list');
			oSelect = $('[sc = select-wrap]');
			getDataUrl = reqBase + 'vshop/shopGoodsOptions';

			until.show( oTplSelect, oSelect, getDataUrl, gparam );
		...
		scroller: function() {
			...
			oTplNew = require('../../tpl/build/goods/list');
			oNew = $('[sc = goods]');
			
			this.oScroll.requestUrl = reqBase + 'vshop/getShopGoods';
