...
<div class="layer-content">
	...
	<div class="list">
		...
		<div class="reply-list">
			<table width="100%">
				{{each data.gm_selection_list}}
					<tr sc="list">
						<td width="10%">
							<input type="radio" name="radio1" sc="goods-select-item" scid="{{$value.goods_id}}" />
						</td>
						<td width="30%">
		...
		<div class="table-bottom">
			...
			<a class="btn btn-primary fr mt_5 mr_10 small" sc="goods-confirm-select" type="single">确定</a>
		</div>
	</div>
</div>
</script>