...
<script>
 ...
 <body id="activity-detail">   
  ...
  <div class="page-bizinfo">
    ...
    <div class="header">
         <h1 id="activity-name"><?php echo $reply_title;?></h1>
         <p class="activity-info">
             ...
             <span class="text-ellipsis"><?php echo $reply_keyword;?></span><i class="icon_link_arrow"></i></a>
         </p>
     </div>
    </div>
    <div class="page-content">
        <div class="media" id="media">
          ...
          <img src="<?php echo $reply_top_pic;?>" />

        </div>
        <div class="text"><?php echo $reply_content;?></div>
   ...
   <script>
      ...
      var title     = trim("<?php echo $reply_title;?>".replace(/&lt;/g, '<').replace(/&gt;/g, '>'));
  ...
  (function(){
          var onBridgeReady =  function () {
              var 
                ...
                imgUrl = "<?php echo $reply_top_pic;?>",
                link   = "<?php echo $url_reply;?>",
                title  = htmlDecode("<?php echo $reply_title;?>"),
                desc   = htmlDecode("<?php echo $reply_desc;?>"),
                fakeid = "",
                desc = desc || link;
