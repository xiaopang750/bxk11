...
<!-- 编辑 -->
<script type="text/html" id="shop-add">
<div class="form-group" script-role="check_wrap">
	<label class="label-control col-1 fl">实体店名称:</label>
	<div class="col-2 fl">
		<input type="text" class="form-control" name="shop_name" form_check="sys" ischeck="true" tip="实体店名称不能为空" wrong="请填写30位以内的门店名称" re="(.{1,30})" value="{{data.shop_name}}" />
...
<div class="form-group">
	...
	<div class="fl col-2" script-role="check_wrap">
		<input type="text" class="form-control"  name="shop_address" form_check="sys" ischeck="true" tip="门店详细地址不能为空" wrong="请填写50位以内的门店详细地址" re="(.{1,50})" value="{{data.shop_address}}" />
	</div>
	<label class="label-control col-1 fl pl_30 red">*</label>
</div>
...
<div class="form-group"  script-role="check_wrap">
	...
	<input type="text" class="form-control col-2 fl" name="shop_tel" form_check="sys" ischeck="true" tip="联系电话不能为空" wrong="联系电话不能为空" re=".+" value="{{data.shop_tel}}" />
</div>
...
<div class="form-group">
	<form action="/lgwx/index.php/upload/serviceShop" enctype="multipart/form-data" target="uploadframe" script-role="upload-form" method="post">
		<div script-role="check_wrap">
			...
			<span class="red">*至少上传一张店面实景图</span>
		</div>
...
<script>
	seajs.use('main/manage_shop_add.js');
</script>
</body>
</html>