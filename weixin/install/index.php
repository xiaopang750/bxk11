...
//参数设置
define('SOFT_VERSION', '11-');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '多用户微信营销开发平台wx-'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><br><h1>系统安装说明</h1>
				<p>感谢您选择微信营销平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的说明：</p>
			<strong>一、本软件版本为<b>'. SOFT_NAME . SOFT_RELEASE .'</b>更新</strong>
			    <p></p>
			<strong>二、安装事项 </strong>
				<b><p>1、填写您服务器上的mysql数据库名称，用户名，密码</p>
				<p>2、数据库前缀最好保持为tp_不要随意改动</p>
				<p>3、管理员用户名用户名一定要写成admin</p></b>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微信营销平台V'.SOFT_VERSION.' 安装程序',
...
if (file_exists('lock')){
	...
	echo "好站长资源提示您：系统已经安装过了，如果要重新安装，那么请删除install目录下的lock文件";
	exit;
}
...
<meta content="安装支持：好站长资源 全国咨询热线：0632-5878778" name="Copyright" />
...
?>
			<div class="footer">
			    <p>安装支持：好站长资源 · 全国咨询热线：0632-5878778</p>
			</div>
		</div>
		</div>
		</body>
